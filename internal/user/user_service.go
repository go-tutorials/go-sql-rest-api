...
func NewUserService(db *sql.DB) *DefaultUserService {
	return &DefaultUserService{DB: db}
}

func (m *DefaultUserService) All(ctx context.Context) (*[]User, error) {
...
func (m *DefaultUserService) Load(ctx context.Context, id string) (*User, error) {
	var user User
...
func (m *DefaultUserService) Insert(ctx context.Context, user *User) (int64, error) {
...
func (m *DefaultUserService) Update(ctx context.Context, user *User) (int64, error) {
...
func (m *DefaultUserService) Patch(ctx context.Context, user map[string]interface{}) (int64, error) {
...
func (m *DefaultUserService) Delete(ctx context.Context, id string) (int64, error) {
